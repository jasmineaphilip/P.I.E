...
//int ytcpsocket_read(int socketfd){
//    char buff[11]; //the int will be stored in buffer
//    recv(socketfd, buff, 10, 0);
//    int openFaceValue = atoi(buff);
//
//    return openFaceValue;
//    
//}
//
//int ytcpsocket_readSize(int socketfd){
